...
public class CanvasCamera {
	...
	public CanvasCamera(CanvasCameraConfig camConfig, IntVector2 canvasSize, GameObject parent){
		...
		if (PropertiesSingleton.instance.m_textLog != null)
			PropertiesSingleton.instance.m_textLog.text += ("\n CanvasCamera canvas Size:" + canvasSize.ToString());
	...
	public void updateCameraParameters(Rect screenRect, IntVector2 canvasSize){
		if (PropertiesSingleton.instance.m_textLog != null)
			PropertiesSingleton.instance.m_textLog.text += ("<br> screenRect:" + screenRect.ToString() + " canvas Size:" + canvasSize.ToString());
